...
public class Query3SqlGroupBy implements Query {
    ...
    public List<?> execute(TPCHStreamDB db) {
        ...
        var cusordLineiteimJoinedStream = SQLStreamUtils.streamJoin(
    ...
    public static void main(String[] args) {
        new Query3SqlGroupBy().execute(TPCHStreamDB.get()).forEach(System.out::println);
    }
}
