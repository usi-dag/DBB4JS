...
public class Query7JoinMapMulti implements Query {
    @Override
    public List<?> execute(TPCHStreamDB db) {
        ...
        Comparator<Query7.Result> c1 = Comparator.comparing(r -> r.supp_nation);
        Comparator<Query7.Result> c2 = Comparator.comparing(r -> r.cust_nation);
        Comparator<Query7.Result> c3 = Comparator.comparing(r -> r.l_year);
        Comparator<Query7.Result> comparator = c1.thenComparing(c2).thenComparing(c3);
        ...
        return SQLStreamUtils.streamJoinMapMulti(
                ...
                .collect(Collectors.groupingBy(n -> new Query7.GroupBy(n.n1_name(), n.n2_name(), n.l_shipdate().getYears()),
                        Collector.of(
                                Query7.Result::new, Query7.Result::aggregate, (a, b) -> null
                        )))
                .values()
                .stream()
                .sorted(comparator)
    ...
    public static void main(String[] args) {
        new Query7JoinMapMulti().execute(TPCHStreamDB.get()).forEach(System.out::println);
    }
}
