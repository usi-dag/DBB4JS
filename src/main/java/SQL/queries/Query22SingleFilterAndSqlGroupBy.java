...
public class Query22SingleFilterAndSqlGroupBy implements Query {
    @Override
    public List<?> execute(TPCHStreamDB db) {
        ...
        Comparator<Query22Imperative.Result> comparator = Comparator.comparing(r -> r.cntrycode);
        ...
        return SQLStreamUtils.streamLeftAntiJoin(
                        ...
                        SQLCollectors.groupingBy(Query22.InnerSelect::cntrycode, GroupByCollector.of(
                                (Query22.InnerSelect i) -> new Query22Imperative.Result(i.cntrycode()),
                                (a, b) -> a.aggregate(b.c_acctbal()),
                                (a, b) -> null
                        ))
                )
                .values()
