...
public class Query5JoinMapMulti implements Query {
    @Override
    public List<?> execute(TPCHStreamDB db) {
        ...
        Comparator<Query5.Result> comparator = Comparator.comparing(r -> -r.revenue);
        ...
        return SQLStreamUtils.streamJoinMapMulti(
                        ...
                        Collectors.groupingBy(Query5.NationLine::n_name, Collector.of(
                                Query5.Result::new, Query5.Result::aggregate, (a, b) -> null
                        ))
                )
                .values()
                .stream()
